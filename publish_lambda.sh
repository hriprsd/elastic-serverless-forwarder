...
#        - arn:aws:iam::aws:policy/service-role/AWSLambdaSQSQueueExecutionRole'''
    if "custom-role-prefix" in publish_config_yaml:
        import inspect
        assert isinstance(publish_config_yaml["custom-role-prefix"], str)
        cloudformation_yaml["Resources"].update({"ApplicationElasticServerlessForwarderCustomRole":{"Type":"AWS::IAM::Role","Properties":{"AssumeRolePolicyDocument":{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Principal":{"Service":["lambda.amazonaws.com"]},"Action":["sts:AssumeRole"]}]},"RoleName": "${CUSTOM_ROLE_PREFIX}ApplicationElasticServerlessForwarderRole", "PermissionsBoundary": "arn:aws:iam::206004807011:policy/BasicRole_Boundary","ManagedPolicyArns":["arn:aws:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole","arn:aws:iam::aws:policy/service-role/AWSLambdaVPCAccessExecutionRole","arn:aws:iam::aws:policy/service-role/AWSLambdaSQSQueueExecutionRole"]}}})
